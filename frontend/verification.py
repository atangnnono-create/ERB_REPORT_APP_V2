...
def verification_ui(api: EnhancedAPIClient):
...
def show_verification_flow(api: EnhancedAPIClient, user_email: str, username: str):
...
def check_verification_status(api: EnhancedAPIClient) -> bool:
...
def get_verification_info(api: EnhancedAPIClient, email: str):
