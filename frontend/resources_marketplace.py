...
def resources_marketplace():
    ...
    # REMOVED ALL CSS CONTAINERS - using only plain text
    st.markdown("""
    <style>
    .main {
        background: #f8f9fa;
    ...
    if hasattr(st.session_state, 'current_product'):
        ...
        st.info(f"**Total:** P{st.session_state.product_price}")
